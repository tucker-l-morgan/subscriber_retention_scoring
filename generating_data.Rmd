...
The `renewal_flag` field is what we'll use in our analysis, and we can see that 65% of users renew. While this may not be true to real data, this will give us a fairly balanced population of outcomes. So let's remove a couple of fields and write this to a csv.
